              ...
              <div className="relative h-full w-full">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center text-center p-6">
                  ...
                  <p className="text-lg text-white mb-6 max-w-md">
                    Professional rescue solutions and emergency response
                    services
                  </p>
                </div>
                {/* Sliding description */}
                <div className="absolute bottom-0 left-0 right-0 bg-white p-8 transform translate-y-full group-hover:translate-y-0 transition-transform duration-500">
                  <p className="text-gray-600 mb-6">
                    Specialized technical rescue operations, equipment, and
                    professional emergency response solutions for challenging
                    environments.
                  </p>
          ...
          <Link href="/training" scroll={true}>
            ...
            >
              <div className="relative h-full w-full">
                ...
                <div className="absolute bottom-0 left-0 right-0 bg-white p-8 transform translate-y-full group-hover:translate-y-0 transition-transform duration-500">
                  <p className="text-gray-600 mb-6">
                    Comprehensive training programs designed to prepare
                    professionals for challenging rescue scenarios and emergency
                    situations.
                  </p>
                  <div className="inline-flex items-center gap-2 text-orange-500 group-hover:gap-3 transition-all">
