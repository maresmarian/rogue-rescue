...
const FEATURES = [
    {
        icon: Shield,
        title: "Expert Team",
        description: "Highly trained professionals with years of experience in rescue operations."
    },
    {
        icon: Clock,
        title: "24/7 Response",
                ...
                <FadeInWhenVisible>
                    <div className="text-center max-w-3xl mx-auto mb-16">
                        ...
                        <p className="text-gray-600">
                            We combine expertise, advanced technology, and unwavering commitment to provide the best rescue and training services.
                        </p>
                    </div>
                </FadeInWhenVisible>
