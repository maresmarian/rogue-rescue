        ...
        >
          ...
          <div>
            ...
            <p className="text-gray-600">
              Rogue Rescue Academy is proud to be a part of the 2025 FDIC
              International Conference. We would like to thank Liberty Mountain,
              for partnering with us to staff a booth. Stop by and say hello.
              We'll see you there Heroes!
            </p>
            <Link
              href="https://www.fdic.com/"
              target="_blank"
