        ...
        <div className="max-w-7xl mx-auto px-6 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <a
                href="https://www.meui-creative.com"
                target="_blank"
                rel="noopener noreferrer"
              ...
              >
                ...
                <div
                  className="absolute -inset-x-2 -inset-y-3 -z-20 opacity-0 transition-opacity duration-500 group-hover:opacity-100"
                  style={{
                    background:
                      'radial-gradient(circle at center, #ffffff08 0%, transparent 100%)',
                  }}
                />
              </a>
            </div>
