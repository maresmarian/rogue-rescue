...
const CAPABILITIES = [
  {
    ...
    description:
      'Specialized medical care in remote and wilderness environments.',
    icon: Shield,
  },
  {
    title: 'Rapid Extraction Module Support (REMS)',
    description:
      '4-person technical rescue crews capable of extracting wildland firefighters from the most austere environments while providing ALS medical treatment.',
    icon: Users,
  },
  {
    title: 'Fireline Paramedics and EMTs',
    description:
      'Capable of accessing and providing wildland firefighters with ALS medical care.',
    icon: Flag,
  },
];
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-20">
          ...
          >
            ...
            <p className="text-xl text-gray-200 mb-8">
              Emergency medical services specialized for wildfire environments
              and remote operations with dedicated crews.
            </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p className="text-gray-600 mb-8">
                Our Wildfire EMS crews provide crucial medical support in
                challenging wildfire environments. With specialized training and
                equipment, we ensure the safety and well-being of firefighting
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Comprehensive medical support services designed for wildfire
              environments.
            </p>
          </motion.div>
