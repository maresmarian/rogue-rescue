...
const SCENARIOS = [
  {
    title: 'Rope Rescue',
    description:
      'Rope rescue personnel trained at the highest level prepared to support any needs.',
    image: '/images/services/high-angle-rescue.jpg',
  },
  {
    title: 'Industrial Facilities',
    description:
      'Specialized rescue services for manufacturing and industrial environments.',
    image: '/images/services/industrial-rescue.jpg',
  },
  {
    title: 'Construction Sites',
    description:
      'Emergency response and rescue operations for construction projects.',
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-20">
          ...
          >
            ...
            <p className="text-xl text-gray-200 mb-8">
              Specialized rescue operations for complex and challenging
              environments.
            </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p className="text-gray-600 mb-8">
                Our technical rescue team specializes in complex rescue
                operations in challenging environments. With years of experience
                and state-of-the-art equipment, we provide professional rescue
                services for industrial, construction, and infrastructure
                settings.
              </p>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              We provide specialized rescue services across various scenarios
              and environments.
            </p>
          </motion.div>
          ...
          <div className="bg-orange-500 rounded-2xl p-12 relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-white/90 mb-8 max-w-xl">
                Our technical rescue team is available 24/7 for emergency
