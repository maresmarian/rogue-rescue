...
const SPECIALIZATIONS = [
  {
    title: 'Tower Rescue',
    description:
      'Specialized rescue operations for telecommunications and wind turbine towers.',
    image: '/images/services/tower-rescue.jpg',
  },
  {
    title: 'Mountain and Wilderness Rescue',
    description:
      'Technical rescue operations in mountainous and wilderness environments.',
    image: '/images/services/mountain-rescue.jpg',
  },
  {
    title: 'Industrial Access',
    description:
      'Safe access and rescue capabilities for industrial vertical environments.',
...
const CAPABILITIES = [
  {
    ...
    description:
      'Specialized equipment and techniques for accessing hard-to-reach vertical environments.',
    icon: Mountain,
  },
  {
    title: 'Safety Systems',
    description:
      'Comprehensive safety protocols and redundant systems for secure operations.',
    icon: Shield,
  },
  {
    title: 'Equipment Management',
    description:
      'State-of-the-art rescue equipment with regular maintenance and inspection.',
    icon: Cog,
  },
  {
    title: 'Custom Solutions',
    description:
      'Tailored rescue plans for unique vertical environments and challenges.',
    icon: Clipboard,
  },
];
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-20">
          ...
          >
            ...
            <p className="text-xl text-gray-200 mb-8">
              Professional vertical rescue operations and safety systems for
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p className="text-gray-600 mb-8">
                Our high angle rescue team specializes in complex vertical
                rescue operations, providing professional services for
                industrial, recreational, and emergency scenarios. With advanced
                equipment and extensive training, we ensure safe and efficient
                rescue operations in challenging vertical environments.
              </p>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Comprehensive vertical rescue solutions backed by advanced
      ...
      <section className="py-24 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Expert vertical rescue services across diverse environments and
              scenarios.
            </p>
          </motion.div>
          ...
          <div className="bg-orange-500 rounded-2xl p-12 relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-white/90 mb-8 max-w-xl">
                Our high angle rescue team is available 24/7 for emergency
                response. Contact us immediately for urgent rescue operations.
              </p>
              <div className="flex flex-col sm:flex-row gap-4">
                <a
