...
export const SERVICES: Service[] = [
  {
    ...
    fullDescription:
      'Comprehensive emergency medical services tailored for wildfire environments with rapid response capabilities.',
    icon: 'Activity',
  ...
  },
  {
    ...
    fullDescription:
      'Expert technical rescue services for complex scenarios requiring specialized equipment and training.',
    icon: 'Map',
  ...
  },
  {
    ...
    fullDescription:
      'Professional high angle rescue services and rope access solutions for elevated emergencies.',
    icon: 'Clock',
