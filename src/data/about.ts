...
export const ABOUT_VALUES: AboutValue[] = [
  {
    title: 'Excellence',
    description:
      'We maintain the highest standards in rescue operations and training, continuously improving our methods and techniques to provide superior service.',
  },
  {
    title: 'Safety',
    description:
      'Safety is paramount in everything we do. We ensure thorough risk assessment and maintain rigorous safety protocols in all our operations.',
  },
  {
    title: 'Innovation',
    description:
      'We embrace advanced technology and innovative approaches to enhance our rescue capabilities and training methodologies.',
  },
];
